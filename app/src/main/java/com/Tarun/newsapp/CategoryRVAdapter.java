...
public class CategoryRVAdapter extends RecyclerView.Adapter<CategoryRVAdapter.ViewHolder> {
    ...
    private ArrayList<CategoryRV> categoryRVModals;
    private Context context;
    private CategoryClickInterface categoryClickInterface;

    public CategoryRVAdapter(ArrayList<CategoryRV> categoryRVModal, Context context, CategoryClickInterface categoryClickInterface) {
    ...
    public void onBindViewHolder(@NonNull CategoryRVAdapter.ViewHolder holder, int position) {
        ...
        CategoryRV categoryRVModal = categoryRVModals.get(position);
